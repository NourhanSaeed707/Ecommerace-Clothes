...
@section('navbaar')
  ...
  <br><br><br><div class="container womanSection">
     <div class="row align-items-center  justify-content-between">
          @foreach($kidgirlClothes as $cloth)
           <div class="col-md-3">
               <div class="item img">
                <?php
                $pieces = explode(',',$cloth['image']);
                ?>
               <br><br><a href="/kidgirlclotheshow/{{$cloth['productid']}}">
                 <img src="/images/kidsGirl/clothes/{{$pieces[0]}}" alt="cloth" width="100%">
                </a>
               </div>
