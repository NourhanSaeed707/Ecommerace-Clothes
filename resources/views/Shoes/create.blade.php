...
@section('navbaar')
   ...
   <body>
    ...
    <br><br><form class="form_create" action="{{route('shoes.store')}}" enctype="multipart/form-data" method="post" >
        @csrf
        ...
        <div class="mb-3">
            <label for="exampleInputsmall" class="form-label">Number of 37 sizes</label>
            <input type="text" class="form-control" name="size_37" id="exampleInputsmall" aria-describedby="smallHelp">
            @foreach ($errors->get('size_37') as $message)
              <div class="alert alert-danger">{{ $message }}</div>
            @endforeach
        </div>
        <div class="mb-3">
            <label for="exampleInputmedium" class="form-label">Number of 38 sizes</label>
            <input type="text" class="form-control" name="size_38" id="exampleInputmedium" aria-describedby="mediumHelp">
            @foreach ($errors->get('size_38') as $message)
              <div class="alert alert-danger">{{ $message }}</div>
            @endforeach
        </div>
        <div class="mb-3">
            <label for="exampleInputlarge" class="form-label">Number of 39 sizes</label>
            <input type="text" class="form-control" name="size_39" id="exampleInputlarge" aria-describedby="largeHelp">
            @foreach ($errors->get('size_39') as $message)
              <div class="alert alert-danger">{{ $message }}</div>
            @endforeach
        </div>
        <div class="mb-3">
            <label for="exampleInputxl" class="form-label">Number of 40 sizes</label>
            <input type="text" class="form-control" name="size_40" id="exampleInputxl" aria-describedby="xlHelp">
            @foreach ($errors->get('size_40') as $message)
              <div class="alert alert-danger">{{ $message }}</div>
            @endforeach
        </div>
        <div class="mb-3">
