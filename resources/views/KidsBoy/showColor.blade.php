     ...
     <br><br><br> <div class="container">
          <div class="row   justify-content-between">
              <div class="col-md-6 image_side">
                <img src="/images/kidsBoy/clothes/{{$photo}}" alt="cloth" width="100%" height="100%">
              </div> <!-- image_side -->
              ...
              <div class="color">
                ...
                <br><form action="/kidboyclotheaddToCard/{{$kidboyCloth[0]['productid']}}/{{$photo}}/{{$color}}"  method="post">
                  @csrf
