     ...
     <br><br><br> <div class="container">
          <div class="row   justify-content-between">
              <div class="col-md-6 image_side">
                <?php
                  if($womenCloth[0]['image'] != ""){
                    $pieces = explode(',',$womenCloth[0]['image']);}
                ?>
                <img src="/images/womenClothes/clothes/{{$pieces[0]}}" alt="cloth" width="100%" height="100%">
              </div> <!-- image_side -->
              ...
              <div class="color">
                ...
                <!-- /{{$womenCloth[0]['productid']}}/{{$pieces[0]}}/{{$color}} -->
                <br><form action="/womanclotheaddToCard/{{$womenCloth[0]['productid']}}/{{$pieces[0]}}/{{$color}}"  method="post">
                  @csrf
