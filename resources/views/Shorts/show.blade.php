     ...
     <br><br><br> <div class="container">
          <div class="row   justify-content-between">
              <div class="col-md-6 image_side">
                <?php
                  if($shorts[0]['image'] != ""){
                    $pieces = explode(',',$shorts[0]['image']);}
                ?>
                <img src="/images/shorts/clothes/{{$pieces[0]}}" alt="cloth" width="100%" height="100%">
              </div> <!-- image_side -->
              ...
              <div class="color">
                ...
                <br><form action="/shortsclotheaddToCard/{{$shorts[0]['productid']}}/{{$pieces[0]}}/{{$color}}"  method="post">
                  @csrf
